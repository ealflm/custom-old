...
vim.api.nvim_set_hl(0, 'DapBreakpoint', { ctermbg = 0, fg='#ef2929', bg = '#31353f' })
vim.api.nvim_set_hl(0, 'DapLogPoint', { ctermbg = 0, fg='#32afff', bg = '#31353f' })
vim.api.nvim_set_hl(0, 'DapStopped', { ctermbg = 0, fg='#8ae234', bg = '#31353f' })
vim.api.nvim_set_hl(0, 'DapLine', { ctermbg = 0, bg = '#31353f' })

vim.fn.sign_define('DapBreakpoint', { text='●', texthl='DapBreakpoint', linehl='DapLine', numhl='DapBreakpoint' })
